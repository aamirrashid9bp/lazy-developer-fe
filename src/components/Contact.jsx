...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section contact" style={{ background: 'var(--color-bg)' }}>
        ...
        <div className="contact__inner">
          ...
          >
            ...
            <div className="contact__details">
              <div className="contact__detail-row">
                ...
                <div>
                  ...
                  <span>450 Mission Street, Suite 300, San Francisco, CA</span>
                </div>
              </div>
              <div className="contact__detail-row">
                <Phone size={18} />
            ...
            <div className="contact__socials">
              ...
              <a href="#" aria-label="GitHub" className="contact__social-icon">
